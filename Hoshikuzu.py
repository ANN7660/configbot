...
**3.** Clique sur 💾 pour sauvegarder"""
    ...
    btn_leave_embed = Button(label="🎨 Embed Départ", style=discord.ButtonStyle.secondary, emoji="🎨", row=5)
    btn_questionnaire = Button(label="📝 Questionnaire", style=discord.ButtonStyle.secondary, emoji="📝", row=5)
    btn_save = Button(label="💾 Sauvegarder", style=discord.ButtonStyle.success, emoji="💾", row=5)
